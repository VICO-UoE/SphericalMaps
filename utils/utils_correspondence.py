...
def resize_square(img, target_res, resize=True, to_pil=True, edge=False):
...
def featurecat(features1, features2):
    ...
    processed_features1 = features1
    processed_features2 = features2
